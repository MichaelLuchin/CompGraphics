...
def draw_tr_textured(img_mat, z_buff, polygon_texture_nums, texture_coords, texture, x0, y0, z0, x1, y1, z1, x2, y2, z2, i0, i1, i2):
    a = 10000 * coef
...
def draw_tr(img_mat, z_buff, x0, y0, z0, x1, y1, z1, x2, y2, z2, i0, i1, i2):
    a = 10000 * coef
    px0, py0 = a * x0 / z0 + widh / 2, a * y0 / z0 + high / 2
    px1, py1 = a * x1 / z1 + widh / 2, a * y1 / z1 + high / 2
    px2, py2 = a * x2 / z2 + widh / 2, a * y2 / z2 + high / 2
